...
export const girlsProducts: Product[] = [
  { id: "g1", name: "Girls Basher", description: "School basher for girls, comfortable and durable.", price: 595, image: "/images/g1.jpg", sizes: ["S", "M", "L", "XL"], category: "girls" },
  ...
  { id: "g5", name: "SSG Blazer", description: "Tailored navy blazer with gold crest.", price: 1600, image: "/images/g5.jpg", sizes: ["S", "M", "L", "XL"], category: "girls" },
  ...
  { id: "g10", name: "SSG Short Sleeve Shirt", description: "Crisp short sleeve formal shirt.", price: 380, image: "/images/g10.jpg", sizes: ["S", "M", "L", "XL"], category: "girls" },
  { id: "g11", name: "SSG Skirt", description: "Pleated school skirt, knee-length.", price: 580, image: "/images/g11.jpg", sizes: ["S", "M", "L", "XL"], category: "girls" },
...
// BOYS UNIFORM – all .jpeg (fixed from .jpg)
export const boysProducts: Product[] = [
  ...
  { id: "b2", name: "SSG Blazer", description: "Tailored navy blazer with gold crest.", price: 1600, image: "/images/b2.jpeg", sizes: ["S", "M", "L", "XL"], category: "boys" },
  ...
  { id: "b9", name: "SSG Short Sleeve Shirt", description: "Crisp short sleeve formal shirt.", price: 380, image: "/images/b9.jpeg", sizes: ["S", "M", "L", "XL"], category: "boys" },
...
export const swimwearProducts: Product[] = [
  ...
  { id: "sw2", name: "SSG Boys Jammer", description: "Comfortable swim jammer for boys.", price: 420, image: "/images/sw2.jpg", sizes: ["S", "M", "L", "XL"], category: "swimwear" },
  { id: "sw3", name: "SSG Girls Costume", description: "School swim costume for girls.", price: 480, image: "/images/sw3.png", sizes: ["S", "M", "L", "XL"], category: "swimwear" },
...
export const sportswearProducts: Product[] = [
  ...
  { id: "s4", name: "SSG Sport Short", description: "Breathable sport shorts for PE.", price: 550, image: "/images/s4.jpg", sizes: ["S", "M", "L", "XL"], category: "sportswear" },
  { id: "s5", name: "SSG Sport Skirt", description: "Sport skirt for girls with school colors.", price: 520, image: "/images/s5.jpg", sizes: ["S", "M", "L", "XL"], category: "sportswear" },
